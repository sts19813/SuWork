...
@push('styles')
    <style>
        ...
        @media (max-width: 767.98px) {
            ...
            #chargesTable .charges-list-row td[data-mobile-label='Acciones']::before,
            #monthChargesTable .charges-list-row td[data-mobile-label='Acciones']::before,
            #paymentsTable .charges-list-row td[data-mobile-label='Acciones']::before {
                content: none;
            }
                                        ...
                                        <td data-mobile-label="Comprobantes" class="pe-7">
                                            @if ($receipts->isNotEmpty())
                                                <div class="d-flex flex-wrap gap-2 justify-content-end">
                                                    ...
                                                    @endforeach
                                                    @if ($receipts->count() > 1)
                                                        <a href="{{ route('charges.receipts.download', $charge) }}" class="btn btn-sm btn-primary">Descargar todos</a>
                                                    @endif
                                                </div>
                                            @else
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4">
                                                    ...
                                                    @if ($canDeleteCharge)
                                                        ...
                                                        <form method="POST" action="{{ route('charges.destroy', $charge) }}"
                                                            ...
                                                            data-charge-concept="{{ $charge->concept }}" data-charge-paid="true">
                                                            @csrf
                                                            @method('DELETE')
