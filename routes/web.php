...
Route::middleware(['auth', 'system.access', 'provider.operational'])
    ->group(function () {
        ...
        Route::middleware('property.visible')->group(function () {
        ...
        Route::put('/cobranza/propiedades/{property}/configuracion', [ChargeController::class, 'updatePropertySetup'])->middleware('property.visible')->name('charges.properties.setup');
        ...
        Route::put('/gastos/propiedades/{property}/configuracion', [ExpenseController::class, 'updatePropertySetup'])->middleware('property.visible')->name('expenses.properties.setup');
        Route::post('/gastos/propiedades/{property}/items-recurrentes', [ExpenseController::class, 'storeRecurringItem'])->middleware('property.visible')->name('expenses.recurring-items.store');
